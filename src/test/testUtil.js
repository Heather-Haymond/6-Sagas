...
import { createAppStore as getStore } from '../store';
...
/**
 * Mount a React component using React Test Library.
 * Provide the redux store, and a in-memory Router
 * for testing.
 */
export const mountWithAll = (ui, options) => (
